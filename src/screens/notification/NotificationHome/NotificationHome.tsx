...
import { View, FlatList, ActivityIndicator, StyleSheet, TouchableOpacity, Button, Text, RefreshControl } from 'react-native';
...
import {getNotificationsApi, INotificationResponse, markNotificationAsReadApi} from "src/services/noti.services";
    ...
    const loadNotifications = async (loadMore = false) => {
        ...
        try {
            ...
            if (response.meta.code === 1000) {
                const notificationsData: Notification[] = response.data.map((item: INotificationResponse) => ({
                    id: item.id,
                    title: item.type,
